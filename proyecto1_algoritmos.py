...
#TODO:
#Revisar condición -> param n: número de nodos (> 0)
...
#grafoGeografico
gfGeografico = grafoGeografico(n=30, r=0.5, dirigido=False, auto=False)
gfGeografico.graphviz()

#grafoGeografico
gfGeografico = grafoGeografico(n=100, r=0.5, dirigido=False, auto=False)
gfGeografico.graphviz()

#grafoGeografico
gfGeografico = grafoGeografico(n=500, r=0.5, dirigido=False, auto=False)
gfGeografico.graphviz()
